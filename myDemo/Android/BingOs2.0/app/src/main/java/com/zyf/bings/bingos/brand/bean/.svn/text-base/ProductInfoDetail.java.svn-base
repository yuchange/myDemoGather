...
/**
 * 功能：
 * Created by yaoyafeng on 17/2/8 上午10:05
 *
 * @modificationHistory 逻辑或功能性重大变更记录
 * @modify by user: {修改人} 17/2/8 上午10:05
...
public class ProductInfoDetail {
    ...
    private String unit;
    private String activity;//mPromotionTime
    ...
    public String toString() {
        return "ProductInfoDetail{" +
                ...
                ", isDeleted='" + isDeleted + '\'' +
                ", bsjProductId='" + bsjProductId + '\'' +
                ", price='" + price + '\'' +
                ", bsjProductName='" + bsjProductName + '\'' +
                ", bsjProductCode='" + bsjProductCode + '\'' +
                ", weight='" + weight + '\'' +
                ", goodsCat='" + goodsCat + '\'' +
