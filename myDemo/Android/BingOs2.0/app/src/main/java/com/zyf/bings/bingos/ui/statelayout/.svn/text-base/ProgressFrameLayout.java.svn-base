package com.zyf.bings.bingos.ui.statelayout;
...
public class ProgressFrameLayout extends FrameLayout {
    ...
    int loadingStateProgressMarginTop;
    ...
    private void init(AttributeSet attrs) {
        ...
        loadingStateProgressMarginTop =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_loadingProgressMarginTop, 200);
        ...
        emptyStateImageWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_emptyImageWidth, 132);

        emptyStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_emptyImageHeight, 96);

        emptyStateMarginTop =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_emptyImageMarginTop, 150);
        ...
        errorStateImageWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_errorImageWidth, 132);

        errorStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_errorImageHeight, 96);


        errorStateMarginTop =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_errorImageMarginTop, 150);

        errorStateTitleTextSize =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_errorTitleTextSize, 17);

        errorStateContentTextSize =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_errorContentTextSize, 16);
    ...
    private void setLoadingView() {
        if (loadingStateFrameLayout == null) {
          ...
          /*  // Setup ProgressBar
            ...
            layoutParams.setMargins(0, loadingStateProgressMarginTop, 0, 0);
    ...
    private void setEmptyView() {
        if (emptyStateFrameLayout == null) {
            ...
            layoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.MATCH_PARENT);
            layoutParams.gravity = CENTER_IN_PARENT;
            layoutParams.setMargins(0, emptyStateMarginTop, 0, 0);
    ...
    private void setErrorView() {
        if (errorStateFrameLayout == null) {
            ...
            layoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.MATCH_PARENT);
            layoutParams.gravity = CENTER_IN_PARENT;
            layoutParams.setMargins(0, errorStateMarginTop, 0, 0);
