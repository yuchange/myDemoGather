...
public class Util {
    ...
    public static Bitmap encodeAsBitmap(String str) {
        ...
        try {
            result = multiFormatWriter.encode(str, BarcodeFormat.QR_CODE, DensityUtil.dp2px(ApplicationHolder.instance,275), DensityUtil.dp2px(ApplicationHolder.instance,275));
            ...
            bitmap.setPixels(pixels, 0, DensityUtil.dp2px(ApplicationHolder.instance,275), 0, 0, w, h);
