package com.zyf.bings.bingos.ui.banner;
...
import com.zyf.bings.bingos.ui.banner.loader.ImageLoaderInterface;
import com.zyf.bings.bingos.ui.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mContainerView = LayoutInflater.from(context).inflate(mLayoutResId, this, true);
        viewPager = (BannerViewPager) mContainerView.findViewById(R.id.bannerViewPager);
        titleView = (LinearLayout) mContainerView.findViewById(R.id.titleView);
        indicator = (LinearLayout) mContainerView.findViewById(R.id.circleIndicator);
        indicatorInside = (LinearLayout) mContainerView.findViewById(R.id.indicatorInside);
        bannerTitle = (TextView) mContainerView.findViewById(R.id.bannerTitle);
        numIndicator = (TextView) mContainerView.findViewById(R.id.numIndicator);
        numIndicatorInside = (TextView) mContainerView.findViewById(R.id.numIndicatorInside);
        initViewPagerScroll();
    ...
    private void setTitleStyleUI() {
        if (titles.size() != imageUrls.size()) {
            throw new RuntimeException("[BannerInfo] --> The number of titles and images is different");
        }
    ...
    class BannerPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            Log.e("BannerPagerAdapter", "instantiateItem: width  " + width);
            Log.e("BannerPagerAdapter", "instantiateItem: height " + height);*/

            if (mContainerView != null) {
                View viewById = mContainerView.findViewById(R.id.iv_goodsdetail_banner_addcart);
                if (viewById != null) {
                    Integer height = viewById.getHeight();
                    Integer width = viewById.getWidth();
                    Log.e("BannerInfo", "onFinishInflate: width  " + width + "  height   " + height);
                }
            }
            return view;
        }
