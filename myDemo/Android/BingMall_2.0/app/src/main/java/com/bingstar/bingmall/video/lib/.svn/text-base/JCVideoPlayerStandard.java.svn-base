...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    public OnPlayItemClickListener listener;

    public LinearLayout addCartLinearLayout;
    public LinearLayout quickOrderLinearLayout;
    public LinearLayout goodsDetailsLinearLayout;
    private Object tagObj;

    public boolean hideGoodsDetailLogo = false;
    ...
    public void init(Context context) {
        ...
        addCartLinearLayout = (LinearLayout) findViewById(R.id.add_cart);
        quickOrderLinearLayout = (LinearLayout) findViewById(R.id.quick_order);
        goodsDetailsLinearLayout = (LinearLayout) findViewById(R.id.jc_goods_details);
        addCartLinearLayout.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                listener.onAddCartItemClick(v, getTagObj());
            }
        });
        quickOrderLinearLayout.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                listener.onQuickOrderItemClick(v, getTagObj());
            }
        });
        goodsDetailsLinearLayout.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                listener.onGoodsDetailsItemClick(v, getTagObj());
            }
        });
    ...
    public void serOnPlayItemClickListener(OnPlayItemClickListener listener) {
    ...
    public boolean getHideGoodsDetailLogo() {
        return hideGoodsDetailLogo;
    }

    public void setHideGoodsDetailLogo(boolean hideGoodsDetailLogo) {
        if (hideGoodsDetailLogo) {
            goodsDetailsLinearLayout.setVisibility(GONE);
            quickOrderLinearLayout.setVisibility(GONE);
        } else {
            quickOrderLinearLayout.setVisibility(VISIBLE);
            goodsDetailsLinearLayout.setVisibility(VISIBLE);
        }
    }

    public void setHideGoodsOneKey(boolean hideGoodsOneKey) {
        if (hideGoodsOneKey) {
            quickOrderLinearLayout.setVisibility(GONE);
        } else {
            quickOrderLinearLayout.setVisibility(VISIBLE);
    ...
    public void setHideAll(boolean hideAll) {
        if (hideAll) {
            quickOrderLinearLayout.setVisibility(GONE);
            goodsDetailsLinearLayout.setVisibility(GONE);
            addCartLinearLayout.setVisibility(GONE);
        } else {
            quickOrderLinearLayout.setVisibility(VISIBLE);
            goodsDetailsLinearLayout.setVisibility(VISIBLE);
            addCartLinearLayout.setVisibility(VISIBLE);
        }
    }
}
