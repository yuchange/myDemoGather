...
public class CartItemDecoration extends RecyclerView.ItemDecoration{
     ...
     */
    public CartItemDecoration(Context context, int orientation) {
     ...
     */
    public CartItemDecoration(Context context, int orientation, int drawableId) {
        this.setOrientation(orientation);
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        final int top = parent.getPaddingTop()+10;
        final int bottom = parent.getMeasuredHeight() - parent.getPaddingBottom()-10;
        final int childSize = parent.getChildCount();
