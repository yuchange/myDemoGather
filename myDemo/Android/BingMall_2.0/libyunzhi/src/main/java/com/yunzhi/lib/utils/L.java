...
import com.yunzhi.lib.logger.Logger;
import com.yunzhi.lib.logger.Settings;
import com.yunzhi.lib.logger.Timber;
    ...
    public static void init(boolean debug) {
        Logger.initialize(
                new Settings()
                        ...
                        .setMethodOffset(1)
                        .setLogPriority(debug ? Log.VERBOSE : Log.ASSERT));
    }
